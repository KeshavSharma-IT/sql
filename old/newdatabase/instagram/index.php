		...
		if (isset($_POST['login']))
		{
			...
			if ($z) {
				...
				while ($row=mysqli_fetch_array($z)) {
							echo $row['username'];	
				header("location:first.php/".$row['username']);
				}
			}
...
<!--<script type="text/javascript">
			function abc() {
				...
				if (a=='') {
					document.getElementById("error").innerHTML='<div style="color=red;">required field</div>';
				}
			...
			function ab() {
				...
				if(a!='')
    {
      document.getElementById("error").innerHTML='<div style="color:green">good</div>';
    }
