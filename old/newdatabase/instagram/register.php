...
<body>
		...
		<form class="container my-5 p-5 border border-dark rounded w-25" method="post">
			<div class="text-cwenter mb-3" style="font-family:lucida handwriting; font-size: 30px;"><b>instagram</b></div>
			<div class="form-group">
				
				<input type="text" name="email" placeholder="Email and mobile no" class="form-control " id="emailr"  onkeyup="ab()">
			</div>
			<div class="form-group">
				
				<input type="text" name="name" placeholder="name" class="form-control " id="namer"  onkeyup="ab()">
			</div>
			<div class="form-group">
				
				<input type="text" name="username" placeholder="username" class="form-control " id="usernamer"  onkeyup="ab()">
			</div>
			<div class="form-group">
				
				<input type="password" name="password" placeholder="Password" class="form-control" id="passwordr" onkeyup="ab()">
				
			</div>
			<div class="form-group">
				<input type="submit" name="register" value="Register" class="btn btn-success " onclick="abc()">
		
				<a href="index.php"  target="_blank" input type="submit" name="login" class="btn btn-success mx-4 " value="LOGIN" onclick="abc()">LOGIN</a>
			</div>
			<div>
...
<button class="btn btn-success " data-toggle="modal" data-target="#keshav1" >open modal</button></center>

<div class="modal fade" id="keshav1" role="dialog">
		
		<div  class="modal-dialog">
			<div class="modal-content" style="width:120%">
				<div class="modal-header">
					<h3> welcome to my data</h3>
						...
						while ($row=mysqli_fetch_array($q)) {
							...
							<tr>
								...
								<td>
									...
									<button type="button" id="<?php echo $row[username];?>" class="mydata"><i class="fa fa-edit" ></i></button>
								...
								<td> 
									...
									<button type="submit" name="delete" value="<?php echo $row[username];
